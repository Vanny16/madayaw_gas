                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            @if(isset($search_string))
                                                <input type="text" class="form-control" name="search_string" placeholder="Employee Name" value="{{ $search_string }}" required/>
                                            @else
                                                <input type="text" class="form-control" name="search_string" placeholder="Employee Name" required/>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            {{-- <div id="remarksModal-{{$dtr_record->tme_id}}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="POST" action="{{ action('EmployeeController@setRemarks') }}">
                                                        {{ csrf_field() }} 
