    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            {{ csrf_field() }} 
                <div class="modal-body">
                    <div class="form-group"> 
                        <label for="cus_name">Price Adjustment<span style="color:red">*</span></label>
                        <input type="decimal"class="form-control" placeholder="Enter Price Adjustment" id="price-change" name="price_change" required onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 45 && event.charCode <= 57))"/>
