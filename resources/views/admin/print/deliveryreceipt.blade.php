        ...
        <div class="card">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-12 mb-6">
                    <p class="text-danger mr-2">{{ $transactions->trx_ref_id }}</p>
                </div>
            </div>
        </div>
