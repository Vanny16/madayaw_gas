            ...
            <div class="row">
                <div class="col-md-12"> 
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" method="POST" action="{{ action('DTRController@timecard2') }}">
                            {{ csrf_field() }} 
                ...
                @if(isset($dtr_records))
                    <div class="col-md-12">
                        <a class="btn btn-info" href="{{ action('PrintController@dtr',[$date_from,$date_to,session('emp_id')]) }}" target="_BLANK"><i class="fa fa-print"></i> Print</a>
                    </div>
                @endif
            </div>
        </div>
