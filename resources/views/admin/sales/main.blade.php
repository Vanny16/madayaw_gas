    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="row">
                ...
                <div class="modal-footer">
                    <a href="{{ action('SalesController@main') }}" type="submit" class="btn btn-success" data-toggle="modal" data-target="#receipt-modal"><i class="fa fa-money-bill mr-1"> </i>Pay</a>
